...
class GLPI_FollowUPLink
{
    public function documentItem($session_token, $data, $followupID)
    {
        ...
        CURLOPT_URL => 'https://lcdesk.lowcost.com.br/apirest.php/ITILFollowup/'.$followupID.'/Document_Item/"',
